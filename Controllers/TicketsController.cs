...
namespace Primera.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Id_Vehiculo"] = new SelectList(_context.Vehiculos, "Id_Vehiculo", "Color");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_Ticket,Id_Vehiculo,Id_Espacio,Fecha_hora_entrada,Fecha_hora_salida,Id_Tarifa,PagoTotal")] Ticket ticket)
        {
            ...
            ViewData["Id_Vehiculo"] = new SelectList(_context.Vehiculos, "Id_Vehiculo", "Color", ticket.Id_Vehiculo);
            return View(ticket);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Ticket,Id_Vehiculo,Id_Espacio,Fecha_hora_entrada,Fecha_hora_salida,Id_Tarifa,PagoTotal")] Ticket ticket)
        {
